		...
		<div class = "results">
			...
			<div id="Kurzinformation" class="tabcontent">
				...
				<div id="kurzBox" class="greenBox"> 
					<p>
						<?php echo textparsedown($r_Kurzbeschreibung);?>
					</p>
				</div>
				<div id="imageBox" class="whiteBox">
					<h4>Umsetzungsbeispiel</h4>
						<p>
							...
							<?php echo textparsedown("<figcaption><figcaptionPre>Abb. 1: </figcaptionPre>" . $r_Umsetzungsbeispiel_Beschriftung . "</figcaption>");?>
							</div>
						</p>
				</div>
				...
				<h4>Funktion</h4>
						...
						<table class="resTable">
							...
							<tbody>
								<tr class="hline">
									...
									<td><?php echo textparsedown($r_FlaechenbedarfEW . " m²/EW") ?> </td>
									<td><?php echo textparsedown("Min:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" . $r_Nutzungsdauer_min) ?></td>
								...
								<tr>
									...
									<td><?php echo textparsedown($r_Flaechenbedarfm2XX . " m²/" . $r_FlaechenbedarfXX) ?></td>
									<td><?php echo textparsedown("Max: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" . $r_Nutzungsdauer_max) ?></td>
								...
								<tr>
									...
									<td></td>
									<td><?php echo textparsedown("Üblich:&nbsp; &nbsp; &nbsp; &nbsp;" . $r_Nutzungsdauer_ueblich) ?></td>
						...
						<p>
							...
							<?php echo textparsedown($r_Sammelhinweis);?>
						</p>
					</div>
					<br><br><br><br><br><br>
			</div>
			...
			<h3><?php echo $r_Titel; ?></h3>
				...
				<div id="resBox" class="greenBox">
					...
					<p>
						<?php echo textparsedown($r_Funktionsbeschreibung);?>
					</p>
				</div>
				...
				<div class="whiteBox">
					...
					<p>
						<div class="img_center">
							...
							<br>
							<br>
							<?php echo textparsedown("<figcaption><figcaptionPre>Abb. 2: </figcaptionPre>" . $r_Systemskizze_Beschriftung . "</figcaption>") ?>
						</div>
					</p>
					...
					<p>
						<?php echo textparsedown($r_Planung_freetext);?>
					</p>
								...
								<colgroup>
									...
									for ($i = 0; $i < 5; $i++)
									{
										if ($r_PlanungNormen[$i]['wert']!="" or $r_PlanungNormen[$i+5]['wert']!="" ) {
											echo textparsedown("<tr class='hline'><td>" .  $r_PlanungNormen[$i]['wert'] . "</td>");
											echo textparsedown("<td>" . $r_PlanungNormen[$i+5]['wert'] . "</td></tr>");
										}
					...
					<p>
						<?php echo textparsedown($r_Aufwand_freetext);?>
					</p>
					...
					<p>
					<Div class="boldGray">Hinweis:</Div>
						<?php echo textparsedown($r_Aufwand_hinweis);?>
					</p>
				
					<h4>Weitergehende Hinweise</h4>				
					<p>
						<?php echo textparsedown($r_Weitergehende_freetext);?>
					</p>
					<p>
						<?php 
								...
								<table class='resTable'>
									...
									for ($i = 0; $i < 20; $i++)
									{
										if ($r_Weitergehende_table[$i][1]!="" or $r_Weitergehende_table[$i+20][1]!="") {
											echo textparsedown("<tr class='hline'><td>" . $r_Weitergehende_table[$i][1] . "</td>");
								...
								<table class='resTable'>
									...
									for ($i = 0; $i < 10; $i++)
									{
										if ($r_Bewertung_table[$i][1]!="" or $r_Bewertung_table[$i+10][1]!="") {
											echo textparsedown("<tr class='hline'><td>" . $r_Bewertung_table[$i+10][1] . "</td>");
											echo textparsedown("<td>" . $r_Bewertung_table[$i][1] . "</td></tr>");
										} 
									}							
								echo "</table>";
							}
								...
								<table class='resTable'>
									...
									for ($i = 0; $i < 10; $i++)
									{
										if ($r_VorNach_table[$i][1]!="" or $r_VorNach_table[$i+10][1]!="") {
											echo textparsedown("<tr class='hline'><td>" . $r_VorNach_table[$i+10][1] . "</td>");
											echo textparsedown("<td>" . $r_VorNach_table[$i][1] . "</td></tr>");
										}
									}
								echo "</table>";
							}
						...
						echo "<table class='resTable'>
							...
							<tr class='hline'>";
								if ($r_Fallbsp1[0][0]!="" or $r_Fallbsp1[1][0]!="" or $r_Fallbsp1[2][0]!="" or $r_Fallbsp1[3][0]!="") {
									echo textparsedown("<td>" . $r_Fallbsp1[2][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp1[3][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp1[1][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp1[0][0] . "</td>");
								}
							echo "</tr>
							<tr class='hline'>";
								if ($r_Fallbsp2[0][0]!="" or $r_Fallbsp2[1][0]!="" or $r_Fallbsp2[2][0]!="" or $r_Fallbsp2[3][0]!="") {
									echo textparsedown("<td>" . $r_Fallbsp2[2][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp2[3][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp2[1][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp2[0][0] . "</td>");
								}
							echo "</tr>
							<tr class='hline'>";
								if ($r_Fallbsp3[0][0]!="" or $r_Fallbsp3[1][0]!="" or $r_Fallbsp3[2][0]!="" or $r_Fallbsp3[3][0]!="") {
									echo textparsedown("<td>" . $r_Fallbsp3[2][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp3[3][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp3[1][0] . "</td>");
									echo textparsedown("<td>" . $r_Fallbsp3[0][0] . "</td>");
								}
							echo "</tr>";
